...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7463606692:AAH5O11jWJ1TOEPRcX0Kh9fIi9wvRgCI8Z0")  # ⚠️ Required
    ...
    DB_URL = os.environ.get("DB_URL", "mongodb+srv://Madhan:<password>@cluster0.y0vtta6.mongodb.net/?retryWrites=true&w=majority")  # ⚠️ Required
    ...
    FORCE_SUB = os.environ.get("FORCE_SUB", "AniMovieRulz") # ⚠️ Required Username without @
